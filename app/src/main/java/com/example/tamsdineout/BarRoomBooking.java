...
public class BarRoomBooking extends AppCompatActivity {
    private ImageView table1,table2,table3,table4,table5,table6,table7,table8,table9,table10,table11,table12,table13,table14,table15,table16;
    private TextView tbl1,tbl2, tbl3, tbl4,tbl5,tbl6,tbl7,tbl8,tbl9,tbl10,tbl11,tbl12,tbl13,tbl14,tbl15,tbl16;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bar_room_booking);
        ...
        table15=findViewById(R.id.table15);
        table16=findViewById(R.id.table16);
        ...
        tbl14=findViewById(R.id.tbl14);
        tbl15=findViewById(R.id.tbl15);
        tbl16=findViewById(R.id.tbl16);
    ...
    public void getBookings(){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Bar Room").child(slotE).child(date);
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                long count=dataSnapshot.getChildrenCount();
                Toast.makeText(BarRoomBooking.this, ""+ count, Toast.LENGTH_LONG).show();
                for(int i=1;i < 17;i++){
                    String ret="book"+i;
                    Toast.makeText(BarRoomBooking.this, ""+ret, Toast.LENGTH_LONG).show();
                    if(dataSnapshot.child(ret).exists()){
                        reflectBooking(i);
                        Toast.makeText(BarRoomBooking.this, ""+ i, Toast.LENGTH_LONG).show();
                    }
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(BarRoomBooking.this, "Error Occurred", Toast.LENGTH_LONG).show();
            }
        });
    }
    private void bookTable(int tableNo){
        ...
        DatabaseReference documentReference = firebaseDatabase.getReference("Bar Room").child(slotE);


        documentReference.child(date).child(table).setValue(userI).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(BarRoomBooking.this,"Table Booked",Toast.LENGTH_LONG).show();
                userBooking(userI);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(BarRoomBooking.this,"Table Not Booked",Toast.LENGTH_LONG).show();
            }
        });
        ...
        DatabaseReference documentReference2 = firebaseDatabase2.getReference("Bar Room").child(slotE1);
    ...
    public void userBooking(String num){
        ...
        userBookedTable bookedTable=new userBookedTable("BarRoom",date,timeFormat,num,"UnPaid");

        mFireStore.collection("Bookings").document(userId).set(bookedTable).addOnCompleteListener(BarRoomBooking.this, new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(BarRoomBooking.this, "Loading Please Wait", Toast.LENGTH_LONG).show();
                    Handler handler = new Handler();
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent intent = new Intent(BarRoomBooking.this, BookTableActivity.class);
                            startActivity(intent);
                        }
                    }, 4000);
                } else {
                    Toast.makeText(BarRoomBooking.this, "Please Try Again", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void reflectBooking(int bookedTable){
        ...
        switch (bookedTable){
            ...
            case 12:
                ...
                break;
            case 13:
                tbl13.setText(booked);
                table13.setEnabled(false);
                tbl13.setTextColor(Color.RED);
                break;
            case 14:
                tbl14.setText(booked);
                table14.setEnabled(false);
                tbl14.setTextColor(Color.RED);
                break;
            case 15:
                tbl15.setText(booked);
                table15.setEnabled(false);
                tbl15.setTextColor(Color.RED);
                break;
            case 16:
                tbl16.setText(booked);
                table16.setEnabled(false);
                tbl16.setTextColor(Color.RED);
                break;
            default:
                Toast.makeText(BarRoomBooking.this, "An Unexpected Error Occurred", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void showBookingDetails(final int tableNumber){
        ...
        View dialogView = LayoutInflater.from(BarRoomBooking.this).inflate(R.layout.bookedtableconfirmation, viewGroup, false);
        AlertDialog.Builder builder = new AlertDialog.Builder(BarRoomBooking.this);
        ...
        ambiance.setText("LIQUOR NIGHT , TAM's DINEOUT");
